...
add_filter( 'the_excerpt', 'sj_parse_chat_content', 1, 1 );
add_filter( 'the_content', 'sj_parse_chat_content', 1, 1 );
...
remove_filter( 'the_excerpt', 'sj_parse_chat_content', 1 );
remove_filter( 'the_content', 'sj_parse_chat_content', 1 );
