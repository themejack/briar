...
( function( $, less ) {
	...
	function handle_header() {
		$( '.header__logo' ).hide();
		if ( wp.customize( 'sj_header' ).get() == 'logo' )
	...
	// Header
	wp.customize( 'sj_header', function( value ) {
		handle_header();
	...
	// Social buttons.
	wp.customize( 'sj_footer_social_buttons', function( value ) {
		value.bind( function( to ) {
			var social_buttons = '';
	...
	var get_page_layout = function() {
		...
		return wp.customize( 'sj_' + name + '_layout' ).get();
	};

	var $main = $( '.sj-main-class' ),
			$sidebar = $( '.sj-sidebar-class' );
	...
	var handle_layout = function() {
		...
		if ( page_layout == 'disabled' )
			page_layout = wp.customize( 'sj_global_layout' ).get();
	...
	wp.customize( 'sj_global_layout', handle_layout_change );
	wp.customize( 'sj_home_layout', handle_layout_change );
	wp.customize( 'sj_blog_layout', handle_layout_change );
	wp.customize( 'sj_archive_layout', handle_layout_change );
	wp.customize( 'sj_category_archive_layout', handle_layout_change );
	wp.customize( 'sj_search_layout', handle_layout_change );
	wp.customize( 'sj_404_layout', handle_layout_change );
	wp.customize( 'sj_single_layout', handle_layout_change );
	wp.customize( 'sj_page_layout', handle_layout_change );
	...
	function update_style() {
		...
		var anchor_color = wp.customize( 'sj_anchor_color' ).get();
		...
		var header_color = wp.customize( 'sj_header_color' ).get();
		...
		var menu_color = wp.customize( 'sj_menu_color' ).get();
		...
		var footer_color = wp.customize( 'sj_footer_color' ).get();
		...
		var comments_button_color = wp.customize( 'sj_comments_button_color' ).get();
		...
		var comments_submit_button_color = wp.customize( 'sj_comments_submit_button_color' ).get();
		var comments_submit_button = '.form-submit .submit{background-color: ' + comments_submit_button_color + ';}';

		var title_hover_color = wp.customize( 'sj_title_hover_color' ).get();
		var title_hover = '.post-list .post-item__title a:hover, .post-list .post-item__title a:focus{color: ' + title_hover_color + ';}';

		var prev_next_posts_color = wp.customize( 'sj_prev_next_posts_color' ).get();
		...
		var search_button_color = wp.customize( 'sj_search_button_color' ).get();
		...
		var audio_color = wp.customize( 'sj_audio_color' ).get();
		...
		var gallery_arrows_color = wp.customize( 'sj_gallery_arrows_color' ).get();
		var gallery_arrows = '.gallery-slider .slick-arrow:before{background-color: ' + gallery_arrows_color + ';}';

		var blog_post_pagination_color = wp.customize( 'sj_blog_post_pagination_color' ).get();
		...
		var password_protected_button_color = wp.customize( 'sj_password_protected_button_color' ).get();
		...
		if ( one_color == false ) {
			if ( wp.customize.preview.window[0].parent.wp.customize( 'sj_custom_style' ).get() !== style_output )
				wp.customize.preview.window[0].parent.wp.customize( 'sj_custom_style' ).set( style_output );
		}
		else {
			if ( wp.customize.preview.window[0].parent.wp.customize( 'sj_custom_style' ).get() !== '' )
				wp.customize.preview.window[0].parent.wp.customize( 'sj_custom_style' ).set( '' );
		}
	...
	wp.customize( 'sj_anchor_color', handle_color );
	wp.customize( 'sj_header_color', handle_color );
	wp.customize( 'sj_menu_color', handle_color );
	wp.customize( 'sj_footer_color', handle_color );
	wp.customize( 'sj_logo_color', handle_color );
	wp.customize( 'sj_readmore_color', handle_color );
	wp.customize( 'sj_comments_button_color', handle_color );
	wp.customize( 'sj_comments_submit_button_color', handle_color );
	wp.customize( 'sj_title_hover_color', handle_color );
	wp.customize( 'sj_prev_next_posts_color', handle_color );
	wp.customize( 'sj_search_button_color', handle_color );
	wp.customize( 'sj_audio_color', handle_color );
	wp.customize( 'sj_gallery_arrows_color', handle_color );
	wp.customize( 'sj_blog_post_pagination_color', handle_color );
	wp.customize( 'sj_password_protected_button_color', handle_color );
